...
<script type="text/javascript">
	...
	function loadOfficePage(currentPage, limit) {
		//先销毁表格  
        ...
        $("#table").bootstrapTable({
        	...
        	dataType: "json",
            url: '<%=request.getContextPath()%>/office/officePage', //获取数据的Servlet地址  
            striped: true,  //表格显示条纹  
	...
	function exportExcel(){
		window.location.href = '<%=request.getContextPath()%>/office/toExportOffice';
	}
	function importOffice(){
		 var url = '<%=request.getContextPath()%>/office/importOfficeExcel';  //   /** 使用ajaxFileUpload */
		    $.ajaxFileUpload({
		        ...
		        success:function(data){
		        	...
		        	loadOfficePage($('#currentPage').val(), $('#limit').val());
		        },
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<shiro:hasPermission name="system.office.import">
				...
				<br /> <br />
				<shiro:hasPermission name="system.office.query">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" id="btn_upSubmit"
					class="btn btn-success pdlr16" data-dismiss="modal" onclick="importOffice()">

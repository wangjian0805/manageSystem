...
<script type="text/javascript">
	...
	function importProduct(){
		 var url = '<%=request.getContextPath()%>/product/importProductExcel'; //   /** 使用ajaxFileUpload */
		$.ajaxFileUpload({
			...
			success : function(data) {
				...
				loadProductPage($('#currentPage').val(), $('#limit').val());
			},
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<shiro:hasPermission name="system.product.import">
				...
				<shiro:hasPermission name="system.product.export">
				<button id="btn_delete" type="button" class="btn btn-default"
					onclick='exportExcel()'>
				...
				<br /> <br />
				<shiro:hasPermission name="system.product.query">

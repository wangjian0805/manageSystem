...
<script type="text/javascript">
	$(document).ready(function() { 
		loadStationPage(1, 10);
	});

	function loadStationPage(currentPage, limit) {
		//先销毁表格  
        ...
        $("#table").bootstrapTable({
        	...
        	dataType: "json",
            url: '<%=request.getContextPath()%>/station/stationPage', //获取数据的Servlet地址  
            striped: true,  //表格显示条纹  
	...
	function importStation(){
		 var url = '<%=request.getContextPath()%>/station/importStationExcel';  //   /** 使用ajaxFileUpload */
		    $.ajaxFileUpload({
		        ...
		        success:function(data){
					...
					loadStationPage($('#currentPage').val(), $('#limit').val());
		        },
   ...
   function selectUploadFile(fileObj){
	...
	function exportExcel(){
		window.location.href = '<%=request.getContextPath()%>/station/toExportStation';
	}
</script>
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<shiro:hasPermission name="system.station.import">
				...
				<br /> <br />
				<shiro:hasPermission name="system.station.query">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" id="btn_upSubmit"
					class="btn btn-success pdlr16" data-dismiss="modal" onclick="importStation()">

			...
			if(!flag){
				...
				$.ajax({
					...
					success : function(data) {
						if (data) {
							window.location.href='<%=request.getContextPath()%>/agent/goToShipmentPage?agentId='+agentId+'&agentName='+encodeURI(encodeURI(agentName))+'&agentFlowDate='+agentFlowDate+'&agentFlowId='+agentFlowId;
						} else {
							bootbox.alert("页面错误");
						}
					},

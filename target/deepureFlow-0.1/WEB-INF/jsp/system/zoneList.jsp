...
<script type="text/javascript">
	...
	function loadZonePage(currentPage, limit) {
		var zoneFunction=$('#czoneFunction').val();
	...
	function delzone() {
		...
		if (zoneList.length > 0) {
			bootbox.confirm("你确定要删除该大区吗!",function(result){
			$.ajax({
				//提交数据的类型 POST GET
				type : "POST",
				//提交的网址
	...
	function operationFormatter(value, row, index){
		...
		operation+="<a class='edit ml10' data-toggle=\"modal\"  title=\"Edit\" href='#' onclick=\"showZonePlan('"+row.zoneId+"');\"><i class='glyphicon glyphicon-pencil'>任务查询</i></a>|";
	...
	<div class="will">
		...
		<div style="text-align: center;">
			...
			<button id="queryButton" class="btn btn-primary"
				style="margin-top: 10px;" onClick="loadZonePage(1,10)">查询</button>
		</div>
...
<%-- 					<shiro:hasPermission name="system.zone.add">
				...
				<table data-show-refresh="false" data-show-toggle="false"
					...
					<thead>
						<tr>
							<th data-field="zoneId" data-checkbox="true">大区编号</th>

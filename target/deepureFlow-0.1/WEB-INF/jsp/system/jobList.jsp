...
<script type="text/javascript">
	...
	function pauseJob(jobKey){
		bootbox.confirm("请确认停止该任务！", function(result) {
			if(result) {
				var params = {};
	...
	function resumeJob(jobKey){
		bootbox.confirm("请确认恢复运行该任务！", function(result) {
			if(result) {
				var params = {};
				params['jobKey'] = jobKey;
	...
	function triggerJob(jobKey){
		bootbox.confirm("请确认触发该任务！", function(result) {
			if(result) {
				var params = {};
				params['jobKey'] = jobKey;
	...
	function deleteJob(jobKey){
		bootbox.confirm("请确认删除该任务！", function(result) {
			if(result) {
				var params = {};
				params['jobKey'] = jobKey;
